...
/// <summary>Ekran zasad trybu gry.</summary>
public partial class RulesPage : ContentPageBase
{
    ...
    public RulesPage(RulesViewModel viewModel, IAnimationPolicy animations)
        : base(animations)
    {
        InitializeComponent();
