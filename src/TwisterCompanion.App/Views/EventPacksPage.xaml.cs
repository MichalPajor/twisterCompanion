...
/// <summary>Ekran paczek wydarzeń.</summary>
public partial class EventPacksPage : ContentPageBase
{
    ...
    public EventPacksPage(EventPacksViewModel viewModel, IAnimationPolicy animations)
        : base(animations)
    {
        InitializeComponent();
