...
/// <summary>Ekran wyboru trybu gry.</summary>
public partial class GameModesPage : ContentPageBase
{
    ...
    public GameModesPage(GameModesViewModel viewModel, IAnimationPolicy animations)
        : base(animations)
    {
        InitializeComponent();
